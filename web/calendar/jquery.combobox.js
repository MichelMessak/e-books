					...
					if (_dropDownListJQuery.is(":hidden"))
					{
						...
						switch (settings.animationType)
						{
							case "slide":
								...
								{
									_dropDownListJQuery.slideDown("slow", setDropDownListFocus);
								}
								break;
								
							case "fade":
								_dropDownListJQuery.fadeIn("slow", setDropDownListFocus);
								break;
					...
					if (_dropDownListJQuery.is(":visible"))
					{
						...
						switch (settings.animationType)
						{
							case "slide":
								...
								{
									_dropDownListJQuery.slideUp("slow", setAndBindContainerFocus)
								}
								break;
								
							case "fade":
								_dropDownListJQuery.fadeOut("slow", setAndBindContainerFocus);
								break;
